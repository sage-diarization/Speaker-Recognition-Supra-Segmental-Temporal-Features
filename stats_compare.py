...
if __name__ == "__main__":
    ...
    run_comparisons({
        "CNN-timit-OS": {
            ...
            "SS": {
                "yours": (11.5, 2.783882181415011, 5),
                "paper": (9.00, 2.15, 5),
            },
        },
        "CNN-timit-SS": {
            "OS": {
                "yours": (6.0, 10.764525070805494, 5),
                "paper": (9.0, 1.66, 5),
            },
            "SS": {
                "yours": (0.0, 0.0, 5),
    ...
    run_comparisons({
        "RNN-timit-OS": {
            "OS": {
                "yours": (4.75, 1.2247448713915892, 5),
                "paper": (1.25, 1.12, 5),
            },
            "SS": {
                "yours": (3.75, 1.369306393762915, 5),
                "paper": (2.75, 0.5, 5),
            },
        },
        "RNN-timit-SS": {
            ...
            "SS": {
                "yours": (2.75, 0.9354143466934852, 5),
                "paper": (0.25, 0.5, 5),
            },
        },
    })
    ...
    run_comparisons({
        ...
        "ResNet-timit-SS": {
            "OS": {
                "yours": (3.75, 1.58113883008419, 5),
                "paper": (2.75, 0.94, 5),
            },
            "SS": {
                "yours": (5, 1.118033988749895, 5),
                "paper": (1.0, 0.94, 5),
            },
        },
    })