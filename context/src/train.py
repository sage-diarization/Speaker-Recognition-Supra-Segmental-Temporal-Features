...
if __name__ == '__main__':
    ...
    parser.add_argument('--quick',            '-q', default=None, type=str)
    parser.add_argument('--workers',          '-w', default=None, type=int)

    parser.add_argument('--batch_size',       '-b', default=None, type=int)
    parser.add_argument('--num_epochs',       '-e', default=None, type=int)
    parser.add_argument('--segment_duration', '-d', default=None, type=float)
    parser.add_argument('--segment_draw',     '-s', default=None, type=str, choices=['OT', 'RF', 'RS'])
